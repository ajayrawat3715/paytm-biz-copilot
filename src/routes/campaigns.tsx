      ...
      <main className="mx-auto max-w-[1180px] px-4 sm:px-7 pt-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="rounded-xl bg-paper px-3.5 py-2 ring-1 ring-line text-xs font-semibold text-ink flex items-center gap-2">
            ...
            <span>{isHindi ? "अनुमानित अतिरिक्त लाभ: +₹2,100" : "Predicted Net Lift: +₹2,100"}</span>
          </div>
        </div>

        {/* Section 1: Interactive What-If Simulation Sandbox */}
        <section className="mt-6 rounded-[22px] bg-paper p-5 ring-1 ring-line sm:p-6 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1.5 rounded-full bg-sand/60 p-1 ring-1 ring-line">
              {[5, 10, 15, 20].map((pct) => (
                <button
                  key={pct}
                  type="button"
                  ...
                  className={cn(
                    ...
                    selectedDiscount === pct
                      ? "bg-rust text-cream shadow-sm scale-105"
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div className="rounded-xl bg-sand/30 p-4 ring-1 ring-line/80">
            ...
            <div className="rounded-xl bg-sand/30 p-4 ring-1 ring-line/80 border-l-4 border-l-emerald">
              <span className="text-xs text-inksoft flex items-center justify-between">
          ...
          <div className="mt-4 rounded-xl bg-cream p-4 ring-1 ring-line flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-start gap-2.5 max-w-2xl">
              <span className="grid size-6 place-items-center rounded-full bg-rust text-cream font-display text-xs shrink-0 mt-0.5">
                भ
              </span>
              <div>
            ...
            {campaignRecipes.map((recipe) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    "cursor-pointer rounded-[20px] bg-paper p-5 ring-1 transition-all shadow-sm flex flex-col justify-between",
                    isSelected ? "ring-2 ring-rust bg-sand/20" : "ring-line hover:bg-sand/10"
                  )}
                >
                  <div>
                    <div className="flex items-start justify-between gap-2">
                      <span className="rounded-full bg-rust/15 px-2.5 py-0.5 text-[10px] font-bold text-rust">
                        {recipe.profitTag}
                      </span>
                      <Clock className="size-3.5 text-inksoft" />
                    </div>

                    <h3 className="mt-2 font-display text-base font-bold text-ink">{recipe.title}</h3>
                    <p className="mt-1 text-xs text-inksoft">{recipe.targetAudience}</p>

                    <div className="mt-3 space-y-1.5 rounded-xl bg-sand/40 p-3 text-xs ring-1 ring-line/60">
                  ...
                  <div className="mt-4 flex items-center justify-between border-t border-line/60 pt-3">
                    ...
                    {isSent ? (
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-full bg-rust px-3 py-1 text-xs font-bold text-cream hover:bg-rust/90 active:scale-95 shadow-sm"
                      >
        ...
        {selectedRecipe && (
          <section className="mt-8 rounded-[22px] bg-paper p-5 ring-1 ring-line sm:p-6 shadow-sm">
            <div className="flex items-center justify-between pb-3 border-b border-line">
              ...
              <span className="rounded-full bg-sand px-3 py-1 text-xs font-bold text-ink ring-1 ring-line">
                Paytm UPI Deep Link
              </span>
            </div>
            ...
            <div className="mt-4 grid grid-cols-1 gap-6 lg:grid-cols-3 items-center">
              <div className="lg:col-span-2">
                <div className="rounded-2xl bg-[#DCF8C6]/30 p-4 text-xs font-sans text-ink ring-1 ring-[#25D366]/30 shadow-inner leading-relaxed">
                  <p className="font-bold text-[#075E54]">Annapurna Kirana — Exclusive Offer</p>
              ...
              <div className="rounded-2xl bg-sand/40 p-4 ring-1 ring-line text-xs space-y-2">
                <p className="font-bold text-ink">{isHindi ? "प्रसारण विवरण:" : "Broadcast Specs:"}</p>
                ...
                <button
                  ...
                  className="w-full mt-2 inline-flex items-center justify-center gap-2 rounded-full bg-[#25D366] px-4 py-2.5 text-xs font-bold text-white shadow-md hover:bg-[#20bd5a] active:scale-95 transition-all"
                >
